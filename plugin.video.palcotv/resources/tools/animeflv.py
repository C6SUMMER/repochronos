# -*- coding: utf-8 -*-
#------------------------------------------------------------
# PalcoTV Parser de animeflv.com
...
def animeflv(params):
    plugintools.log("[PalcoTV 0.3.0].AnimeFLV")
...
def gethttp_referer_headers(url,referer):
    plugintools.log("PalcoTV-0.3.0.gethttp_referer_headers "+url)
    request_headers=[]
...
def getserver(data,server):
    plugintools.log("[Arena+ 0.3.4] AnimeFLV GetServer")
