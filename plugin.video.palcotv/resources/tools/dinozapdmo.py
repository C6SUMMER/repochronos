# -*- coding: utf-8 -*-
#------------------------------------------------------------
# Parser de http://www.dinozap.info by DMax
...
thumbnail = 'http://i.imgur.com/64kVOaM.png'
fanart = 'http://i.imgur.com/DGTkJqB.png'
...
def dinozapdmo0(params):
	plugintools.log("[%s %s] http://www.dinozap.tv %s " % (addonName, addonVersion, repr(params)))

	r = requests.get(url)	
	data = r.content

	plugintools.add_item(action="",url="",title="[COLOR blue][B]                 DinoZap[/B] [I](v1.01)[/I][/COLOR][COLOR yellow][I]    **** byDMax ****[/I][/COLOR]",thumbnail=thumbnail,fanart=fanart,folder=False,isPlayable=False)
